            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-sm-pull-6">
                    <div class="mu-hero-left">
                        <h1>Welcome</h1>
                        <p>"Selamat datang di halaman Perpustkaan kami! Di sini, Anda akan menemukan dunia yang tak terbatas di antara halaman-halaman yang penuh dengan pengetahuan, imajinasi, dan petualangan.
                            Kami dengan bangga menghadirkan koleksi Buku yang beragam, siap mengajak Anda menjelajahi cerita-cerita yang tak terlupakan, belajar dari para ahli, dan menemukan inspirasi baru.
                             Jadi, ambillah kursi, nikmati setiap kata, dan mari bersama-sama menelusuri keajaiban yang tak terbatas dari eBook. Selamat menikmati!"
                        </p>
                        <a href="/login" class="mu-primary-btn">Login</a>
                        <span>*Avaliable in PDF, ePUB, Mobi</span>
                    </div>
                </div>
                        ...
                        <div class="mu-video-review-area">
                            ...
                            <div class="mu-video-review-content">
                                <iframe class="mu-video-iframe" width="100%" height="480"
                                    src="https://youtu.be/2dj56Wwz1l0?si=lzsZGT5YRL7H213Y" frameborder="0"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mu-author-image">
                                            <img src="{{ asset('landing/images/author.jpg') }}" alt="Author Image">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mu-author-info">
                                            ...
                                            <img class="mu-author-sign"
                                                src="{{ asset('landing/images/author-signature.png') }}"
                            ...
                            <div class="mu-testimonials-block">
                                <ul class="mu-testimonial-slide">
                                    ...
                                    <li>
                                        ...
                                        <img class="mu-rt-img" src="{{ asset('landing/images/reader-1.jpg') }}"
                                            alt="img">
                                    ...
                                    <li>
                                        <p>"Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                            Lorem Ipsum has been the industry's standard dummy text ever."</p>
                                        <img class="mu-rt-img" src="{{ asset('landing/images/reader-2.jpg') }}"
                                            alt="img">
                                    ...
                                    <li>
                                        <p>"Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                            Lorem Ipsum has been the industry's standard dummy text ever."</p>
                                        <img class="mu-rt-img" src="{{ asset('landing/images/reader-3.jpg') }}"
                                            alt="img">

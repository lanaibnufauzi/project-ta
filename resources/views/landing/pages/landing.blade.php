...
<section class="product-tabs section-padding position-relative">
    <div class="container">
        ...
        <div class="tab-content" id="myTabContent">
            <div id="test" class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
            ...
            <div>
                @if($jumlah_data > 10) <div class="ajax-load text-center mb-3">
                    <button id="loadmore" class="btn btn-sm btn-success">More</button>
                </div>
                @else
                <div class="ajax-load text-center mb-3">
                    <button id="loadmore" class="btn btn-sm btn-success" style="display: none;">More</button>
                </div>
                @endif
            </div>
            <!--En tab one-->
    ...
    function loadMoreData(page) {
        $.ajax({
            ...
            .done(function(data) {
                ...
                $('#loadmore').show();
                $("#test").append('<div class="row product-grid-4">' + data.html + '</div>');
            })

<header class="header-area header-style-1 header-height-2">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li>
                                        <a href="#"><img src="{{ asset('landing/assets/imgs/theme/flag-fr.png') }}" alt="" />Français</a>
                </li>
                <li>
                    <a href="#"><img src="{{ asset('landing/assets/imgs/theme/flag-dt.png') }}" alt="" />Deutsch</a>
                </li>
                <li>
                    <a href="#"><img src="{{ asset('landing/assets/imgs/theme/flag-ru.png') }}" alt="" />Pусский</a>
                </li>
                </ul>
                </li>
                <li>
                    ...
                    <ul class="language-dropdown">
                        <li>
                            <a href="#"><img src="{{ asset('landing/assets/imgs/theme/flag-fr.png') }}" alt="" />INR</a>
                        </li>
                        <li>
                            <a href="#"><img src="{{ asset('landing/assets/imgs/theme/flag-dt.png') }}" alt="" />MBP</a>
                        </li>
                        <li>
                            <a href="#"><img src="{{ asset('landing/assets/imgs/theme/flag-ru.png') }}" alt="" />EU</a>
                        </li>
                    </ul>
                </li>
                </ul>
                        ...
                        <div class="header-action-2">
                            ...
                            {{-- <div class="header-action-icon-2">
                                <a href='shop-compare.html'>
                                    <img class="svgInject" alt="Nest" src="{{ asset('landing/assets/imgs/theme/icons/icon-compare.svg') }}" />
                        ...
                        <ul class="mega-menu">
                            ...
                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                <div class="menu-banner-wrap">
                                    <a href='shop-product-right.html'><img src="{{ asset('landing/assets/imgs/banner/banner-menu.png') }}" alt="Nest" /></a>
    ...
    <div class="header-action-right d-block d-lg-none">
        <div class="header-action-2">
            <div class="header-action-icon-2">
                <a href='shop-wishlist.html'>
                    <img alt="Nest" src="{{ asset('landing/assets/imgs/theme/icons/icon-heart.svg') }}" />
            ...
            <div class="header-action-icon-2">
                ...
                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                    <ul>
                        ...
                        <li>
                            <div class="shopping-cart-img">
                                <a href='shop-product-right.html'><img alt="Nest" src="{{ asset('landing/assets/imgs/shop/thumbnail-4.jpg') }}" /></a>
                            </div>
                            <div class="shopping-cart-title">
